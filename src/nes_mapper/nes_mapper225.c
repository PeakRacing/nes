...
/* https://www.nesdev.org/wiki/INES_Mapper_225
 * BMC 58-in-1 / 64-in-1 — bank select encoded in address lines.
 * Write $8000-$FFFF:
 *   address[14]   = mirroring (0=V, 1=H)
 *   address[13]   = PRG mode (0=32KB, 1=16KB)
 *   address[12:6] = PRG bank base (7 bits)
...
static void nes_mapper_write(nes_t* nes, uint16_t address, uint8_t data) {
    (void)data;
    uint16_t prg = (uint16_t)((address >> 6) & 0x7Fu);
